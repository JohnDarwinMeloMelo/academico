...
SECRET_KEY = 'django-insecure-br5q17f7zli7+5k)acu9*kxvnb6o^3$dx2w$841g&!topwo_=c'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'scholar',          # Nombre de la base de datos
        'USER': 'root',             # Usuario de MySQL (por defecto, root en XAMPP)
        'PASSWORD': '',             # Contraseña de MySQL (deja en blanco si no la has configurado)
